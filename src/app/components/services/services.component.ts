  ...
  styles: [`
    ...
    .service-card::before {
      ...
      background: linear-gradient(
        to bottom,
        rgba(116,101,101, 0.7),
        rgba(116,101,101, 0.9)
      );
    ...
    .service-card:hover::before {
      background: linear-gradient(
        to bottom,
        rgba(116,101,101, 0.8),
        rgba(116,101,101, 0.95)
      );
    }

    /* Background images for all cards */
    .torah-scroll .bg-image { background-image: url('/assets/images/torah-scroll.jpg'); }
    .tefillin .bg-image { background-image: url('/assets/images/tefillin.jpg'); }
    .mezuzah .bg-image { background-image: url('/assets/images/mezuzah.jpg'); }
    .tallit .bg-image { background-image: url('/assets/images/tallit.jpg'); }
    .kippah .bg-image { background-image: url('/assets/images/kippah.jpg'); }
    .siddur .bg-image { background-image: url('/assets/images/siddur.jpg'); }
    .shabbat .bg-image { background-image: url('/assets/images/shabbat.jpg'); }
    .holidays .bg-image { background-image: url('/assets/images/holidays.jpg'); }
    .kitchenware .bg-image { background-image: url('/assets/images/kitchenware.jpg'); }
    .jewelry .bg-image { background-image: url('/assets/images/jewelry.jpg'); }
    .art .bg-image { background-image: url('/assets/images/art.jpg'); }
    .books .bg-image { background-image: url('/assets/images/books.jpg'); }
